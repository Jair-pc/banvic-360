  ...
  create view "banvic"."gold"."kpi6_carteira_colaborador__dbt_tmp"
...
from "banvic"."gold"."dim_colaborador" col
join "banvic"."gold"."dim_agencia" ag    on ag.sk_agencia = col.sk_agencia_principal
