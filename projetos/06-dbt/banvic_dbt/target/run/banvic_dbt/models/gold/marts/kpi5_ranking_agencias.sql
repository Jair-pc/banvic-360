  ...
  create view "banvic"."gold"."kpi5_ranking_agencias__dbt_tmp"
...
with volume_ag as (
    ...
    join "banvic"."gold"."dim_agencia" ag on ag.sk_agencia = ft.sk_agencia
...
from "banvic"."gold"."kpi1_saldo_agencia" k1
